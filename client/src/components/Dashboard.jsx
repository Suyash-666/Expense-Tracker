...
import { getBudgets, getExpenses, getIncomes } from '../services/api';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const totalBudget = budgetData.reduce((sum, b) => sum + (b.limit || 0), 0);
        setBudget(totalBudget);
        const totalIncome = incomeData.reduce((sum, inc) => sum + (inc.amount || 0), 0);
        setIncome(totalIncome);
      } catch (err) {
        console.error('Error loading dashboard data:', err);
        toast.error('Unable to load latest data');
      }
    };
          ...
          <div className="about-tab">
            <div className="list-section">
              ...
              <div className="app-info">
                ...
                <p><strong>Platform:</strong> Web Application (React + Node API)</p>
              </div>
              ...
              <div className="feature-grid">
                ...
                <div className="feature-card">
                  ...
                  <p>Cloud-based data protection with JWT-secured API</p>
                </div>
                <div className="feature-card">
                  <div className="feature-icon-large">📱</div>
            ...
            <div className="list-section">
              ...
              <div className="help-section">
                ...
                <div className="faq-item">
                  ...
                  <p>
                    Yes! Your data is stored securely on our API. Sign in with the same 
                ...
                <div className="faq-item">
                  ...
                  <p>
                    Absolutely! All data is encrypted and stored via our MongoDB-backed API with industry-standard 
